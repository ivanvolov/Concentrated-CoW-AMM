...
abstract contract ValidateOrderParametersTest is CConstantProductTestHarness {
    function setUpBasicOrder()
        internal
        returns (CConstantProduct.TradingParams memory defaultTradingParams, GPv2Order.Data memory defaultOrder)
    {
    ...
    function testDefaultDoesNotRevert() public {
        (CConstantProduct.TradingParams memory defaultTradingParams, GPv2Order.Data memory defaultOrder) =
            setUpBasicOrder();
