...
import {CConstantProductTestHarness, CConstantProduct, IERC20} from "./CConstantProductTestHarness.sol";
...
abstract contract DeploymentParamsTest is CConstantProductTestHarness {
    ...
    function testDeploymentAllowsVaultRelayer() public {
        ...
        vm.prank(defaultDeployer());
        new CConstantProduct(solutionSettler, token0, token1);
    }
    ...
    function testDeploymentRevertsIfApprovalReverts() public {
        ...
        vm.prank(defaultDeployer());
        new CConstantProduct(solutionSettler, regular, reverting);
    }
    ...
    function testDeploymentRevertsIfApprovalReturnsFalse() public {
        ...
        new CConstantProduct(solutionSettler, falseOnApproval, regular);
    }
    ...
    function testDeploymentSucceedsIfApproveReturnsNoData() public {
        ...
        vm.prank(defaultDeployer());
        new CConstantProduct(solutionSettler, noDataApproval, regular);
    }
