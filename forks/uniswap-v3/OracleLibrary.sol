...
library OracleLibrary {
        ...
        returns (int24 arithmeticMeanTick, uint128 harmonicMeanLiquidity)
    {
        ...
        int56 tickCumulativesDeltaInt56 = int56(int32(secondsAgo)); // Convert secondsAgo to int56
        arithmeticMeanTick = int24(
            tickCumulativesDelta / tickCumulativesDeltaInt56
        );

        int56 secondsAgoInt56 = int56(int32(secondsAgo)); // Convert secondsAgo to int56
    ...
    function getBlockStartingTickAndLiquidity(
        ...
        int56 deltaInt56 = int56(int32(delta)); // Convert delta to int56
        tick = int24((tickCumulative - prevTickCumulative) / deltaInt56);
    ...
    function getWeightedArithmeticMeanTick(
        ...
        for (uint256 i = 0; i < weightedTickData.length; i++) {
            numerator +=
                weightedTickData[i].tick *
                int256(int128(weightedTickData[i].weight)); // Explicit cast to int256
