...
An experimental modification of the CoW AMM that introduces **concentrated liquidity**, improving capital efficiency for liquidity providers while preserving **CoW Protocol’s MEV protection model**.
...
- Concentrated liquidity support for CoW AMM
- Custom liquidity price ranges
- Oracle-based price alignment
- Solver-compatible order generation
- Post-swap state updates via postHook
- Math library based on audited Uniswap components

## Resources

- [Grant application](https://forum.cow.fi/t/grant-application-concentrated-liquidity-cow-amm-rehypothecation-adapter/2632)
- [Forum discussion](https://forum.cow.fi/t/introducing-concentrated-cow-amm-maximizing-capital-efficiency-and-returns-for-liquidity-providers/2571)
- [Version with different oracle implementation](https://github.com/ivanvolov/Concentrated-CoW-AMM/tree/e075f9a4032fb9b2fd1b9e120b8bca7b76188083)
